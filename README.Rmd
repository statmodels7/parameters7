...
covariance as a structure, and takes it on either side: a structure imposed on
$\Sigma$ and the same structure imposed on $\Omega = \Sigma^{-1}$ are
...
The names above are the structure's own `free_names`, which is why they are
