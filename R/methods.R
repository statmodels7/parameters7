#' @include covstruct_class.R numerical_fallbacks.R
NULL


#' @title Print a Covariance Structure
#' @name print.covstruct
#'
#' @description
#' Prints the family, the shape of the matrix, the rank, the free values and
#' which of the derived quantities are numerical.
#'
#' @param x An object inheriting from class \code{\link{covstruct}}.
#' @param ... Unused.
#'
...
#'
#' @keywords internal
S7::method(print, covstruct) <- function(x, ...) {
